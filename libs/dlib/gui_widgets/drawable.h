...
// ----------------------------------------------------------------------------------------
    ...
    public:
            ...
            event_id(0)
        {
            ...
            std::filebuf fb;
            fb.open ("../../data/helvB14.bdf",std::ios::in);
            std::istream in(&fb); 
            bdf_font * bdf;
            bdf = new bdf_font();
            bdf->read_bdf_file(in, 255, 0);
            set_main_font((shared_ptr_thread_safe<dlib::font>) bdf);
            //mfont = (shared_ptr_thread_safe<dlib::font>) bdf;
